        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <a class="nav-link active " aria-current="page" href="#" style="color: black;"
                    onmouseover="turnOnlight(this)" onmouseout="turnOfflight(this)"><img src="/test-main/homePageImg/shopping-cart.png"
    ...
    <div class="container-xl">
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="homePageImg/product/amazon.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="homePageImg/product/testla.PNG" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="homePageImg/product/Source-@brandwithravi-Twitter.png" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="homePageImg/FDKq5_uakAAJhup.png" class="d-block w-100" alt="...">
                </div>
            </div>
        ...
        <c:forEach items="${products}" var="product">
            ...
            <div class="col-lg-4">
                ...
                <a href="showProductInfo?pnum=${product.id}"><img src="showImage?pnum=${product.id}" class="w-100"></a>
                </div>
                <p>${product.name}</p>
